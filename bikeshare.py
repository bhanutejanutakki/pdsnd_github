...
def takerequest():
    ...
    while True:
        ...
        if city not in CITY_DATA:
            print('Please select city from the list chicago/new york city/washington')
        else:
            break
    ...
    while True:
        ...
        if month != 'all' and month not in months:
            print('Please select month from: january / february / march / april / may/june/all')
        else:
            break
    ...
    while True:
        ...
        if day != 'all' and day not in days:
            print('please select day from sunday/monday/tuesday/wednesday/thursday/friday/saturday/all')
        else:
            break
...
def showdata(city):
    ...
    while user_input not in answers:
        print("\nshow last 5 data records : yes/no?")
